  ...
  <nav class="navbar navbar-expand-lg">
    ...
    <div class="container-fluid pr-4 pl-4">
      ...
      <div class="collapse navbar-collapse" id="navbarButtonsExample">
        <div class="d-flex">
          <a href="<?php echo $root; ?>" type="button" class="btn btn-warning me-3 text-white">
            <span class="fa fa-home"></span>
            <span class="ml-1">Home</span>
          </a>
          <a href="<?php echo $root.'shop/'; ?>" type="button" class="btn btn-warning me-3 text-white">
          ...
          <!-- Account -->
          <a href="<?php echo $root.'myaccount/edit.php'; ?>" type="button" class="btn btn-warning me-3 text-white">
